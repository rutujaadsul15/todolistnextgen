...
public class UserPrincipal implements UserDetails {
    ...
    private static List<GrantedAuthority> getAuthorityFromRole(String userRole) {
        ...
        switch (userRole) {
            case "USER":
                authorities.add(new SimpleGrantedAuthority("ROLE_USER")); // HERE "ROLE_" PREFIX IS MUST.
                break;
            case "ADMIN":
                authorities.add(new SimpleGrantedAuthority("ROLE_ADMIN")); // HERE "ROLE_" PREFIX IS MUST.
                break;
            default:
                authorities.add(new SimpleGrantedAuthority("NO_ROLE")); // HERE "ROLE_" PREFIX IS MUST.
        }
        return authorities;
    }
